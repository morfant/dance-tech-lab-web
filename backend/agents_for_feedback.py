...
class GraphState(TypedDict):
    ...
    retrieve_stop: str
    retrieve_count: int   
    user_feedback: Optional[str]  # Added for capturing user feedback
...
system = """You are a professional assistant with a witty and engaging personality. Help users find information with a touch of humor and charm, making every interaction enjoyable and fun.
            Summarize the user's request, and ask them to confirm that you understood correctly.\n 
            If necessary, seek clarifying details.\n
            When the user asks or requests something, you start your response by saying "[Planner 입니다.]"\n 

            1. Context Understanding:
                - First, analyze the user's request by extracting the key objectives, constraints, and desired outcomes.
                - If user's feedback is provided, incorporate it into your understanding and adjust the plan accordingly.
            ...
            2. Step-by-Step Plan:
                ...
                - If the plan is being revised based on user feedback, clearly indicate the changes made.
            ...
            3. Research Areas:
                ...
                - If the research areas are being revised based on user feedback, clearly indicate the changes made.
            ...
            4. Explanation:
                ...
                - If user feedback is integrated, explain how the feedback influenced the plan and the research areas.
            ...
            5. Final Output:
                ...
                - 'explanation': A detailed explanation of the plan and research areas. it starts with "[Planner 입니다.]"
            ...
            2.create research instructions for a Research Agent to research the revised research topics  
                ...
                Use the following framework to develop your instructions:
                    ...
                    - 3.Key Quotes, Passages, and Data:
                        Instruct the Research Agent to extract and present at least five important quotes, passages, or data points relevant to the topic. They should clearly explain the significance of each piece of evidence.
            ...
            2.Develop a comprehensive and detailed prompt for a Research Agent to investigate all topics in the revised research list. Ensure that all topics are addressed one by one and that the research instructions are structured and cover necessary aspects. Follow these steps for each topic:
                ...
                For each topic, Use the following framework to develop your instructions:
                    ...
                    - 3.Key Quotes, Passages:
                        Create instructions for the Research Agent to extract and present at least five important quotes, passages, or data points relevant to the topic. Clearly explain the significance of each piece of evidence.
                    ...
                    - 5.References:
                        Instruct the Research Agent to compile a list of references or citations and  provide a detailed summary of the references that includes key insights. Ensure they follow proper citation formats and provide a comprehensive list of sources.
                       
                    - 6.Further Questions:
                        Encourage the Research Agent to list any additional questions that arise naturally from the topic. These questions should help refine the research focus or guide future exploration.

                    - 7.Find potential Information Sources:
                        Create instructions for the Research Agent to find specific sources that will be useful for the research. Ensure that they include a variety of credible resources (e.g., books, articles)
...
### for researcher
# llm_researcher = ChatAnthropic(model="claude-3-5-sonnet-20240620", max_tokens=8192) #ANTHROPIC
llm_researcher = ChatOpenAI(temperature=0, streaming=True, model="gpt-4o-2024-08-06", max_tokens=8192) #OPENAI

system_01 ="""You are an experienced and detail-oriented researcher who excels at finding accurate and relevant information. 
        As an Analytical Strategist, you approach problems methodically, breaking them down into clear steps and prioritizing data that aligns with the overall goals. 
        You ensure all information is reliable, logically connected, and contributes to a well-thought-out strategy. 
        ...
        2.Search for Relevant Information:
            - MUST follow research instructions to conduct a thorough and structured research on the assigned topic. Follow instructions for each section to cover all aspects of the research. Ensure to understand and execute each step one by one, following the instructions carefully at every stage to meet the objectives fully.
            ...
            - Actively find useful information from credible sources such as academic journals, books, interviews, article, news, and case studies that are directly related to {research}.
            - Extract and present relevant quotes, data, and examples. Ensure that the information directly supports the objectives outlined in the instructions.
            
        3.Additional Tasks:
            - MUST find five academic sources (e.g., journals, articles) related to the specified topics., and present a detailed summary that includes key insights, perspectives offered, and any notable conclusions or themes discussed.
            - MUST find five interview materials related to the specified topics. For each material, provide a detailed summary that includes key insights, perspectives offered, and any notable conclusions or themes discussed.
            - Incorporate five reviews or critiques about the topic to understand its reception and contributions, and present a detailed context that includes key insights, perspectives offered, and any notable conclusions or themes discussed.
            - MUST Extract and present key quotes, passages, and case studies that directly relate to the topic.
        ...
        5.Output:
            - Please provide a comprehensive 1200-word report that thoroughly covers all relevant information, includes insightful analysis, and integrates any pertinent quotes or references you have gathered during the research process. Ensure that the findings are integrated into a cohesive narrative that aligns with the research topic.
            """
...
llm_generate = ChatOpenAI(model_name="gpt-4o", temperature=0, streaming=True)
...
system_01 = """You are an experienced research analyst on various areas such as art, science and other fields.
            Your sole purpose is to write well written, critically acclaimed objective and structured reports on the given archive.
            You organise useful information from the the given {archive} to give an answer to the user.
            You are verbose and logical.
            ...
            you analyze {archive} that you are given and answer the following user's question: {question} in a detaied, well-structured, comprehensive anlaysis of minimum 4500 words that offers in-depth insights into various aspects of the archive {archive}. 
                - Analyze the provided archive and categorize it into at least four distinct categories based on the contexts.
                - Summarize each category clearly and thoroughly. Ensure that all essential details are preserved and do not oversimplify the information.
                - For each category. develop a series of thoughtful and detailed questions related to the each category, then carefully answer each question. Use this process of self-reflection to deepen your understanding and arrive at a more accurate and well-rounded conclusion.
                - You MUST present key quotes, passages, and case studies that directly relate to each category.
                - You MUST present interview materials related to each category. For each material, provide a detailed summary that includes key insights, perspectives offered, and any notable conclusions or themes discussed.
                ...
                - you MUST provide potential information to look at. provide the detailed context of them and the links
                - you MUST provide at least 8 questions that come to mind about the topic: List any questions that naturally arise from the topic, which could guide further exploration or clarify the research objectives.
...
def agent(state):
    ...
    if user_feedback and user_feedback.lower() != "ok":
        response = manager.invoke({"question": f"{question} (user's feedback: {user_feedback})"})
    else:
        response = manager.invoke({"question": question})

    plan = response.plan
    research = response.research_area
...
def check_feedback(state):
    ...
    print(">> proceed 상태는 : {}".format(proceed))
    ...
    # user_feedback = input("계획에 대한 피드백을 입력하세요 (계속하려면 'OK'를 입력하세요): ")

    if user_feedback.lower() == "ok":
        print(">> critic 에이전트에 전달합니다.")
        return {"proceed": True}
    else: 
        print(">> 피드백을 manager에게 전달합니다.")
        return {"proceed": False, "user_feedback": user_feedback }

    # if state.get("user_feedback", "").lower() == "ok":
    #     return {"proceed": True}
    # else:
...
def review(state):
    ...
    return {"plan": revised_plan, "question": question, "research":research }
...
def retrieve(state):
    ...
    if retrieve_stop == "No":
        ...
        if archive == None:
            archive = []
            if response.content != '':    
                RESEARCHER_CONTENT = "[RESEARCHER]: " + response.content   
                archive.append(RESEARCHER_CONTENT)
                print('\n' + ">> Archive START")
...
def grade_documents(state):
    ...
    if archive == None:
        ...
        print('\n' + ">> archive = []")
        if filtered_docs != []:        
            filtered_docs_ = "[VECTOR]: " + ' '.join(filtered_docs)
...
def web_search(state):
    ...
    combined_results = "[WEB SEARCH]: " + " ".join(results)
...
def decide_to_proceed(state):
    print('\n' + ">> ASSES WHETHER TO PROCEED TO THE NEXT STEP")
...
workflow.add_edge("agent", "check_feedback")
...
workflow.add_edge("research_director", END)
# workflow.add_edge("research_director", "researcher") # TEMPORARILY MUTED
# workflow.add_edge("retrieve", "grader") # TEMPORARILY MUTED
